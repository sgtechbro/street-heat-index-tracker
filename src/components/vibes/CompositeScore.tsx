...
const CompositeScore = () => {
  ...
  if (score >= 80) {
    ...
    desc =
      "Every indicator is screaming. The strippers are broke, the freezers are full of DiGiorno, and urologists are booked solid. This is not a drill.";
    statusText = "THE SHIT IS HITTING THE FAN";
    scoreColor = "var(--color-red)";
  } else if (score >= 60) {
    verdict = "Uh oh. Not ideal.";
    verdictClass = "composite__verdict composite__verdict--bad";
    desc =
      "Multiple indicators are flashing red. The champagne has gone flat, the cardboard boxes have stopped moving, and everyone's wearing long skirts. Brace yourself.";
    ...
    desc =
      "Some indicators are flagging, others are fine. The economy is giving mixed signals. Relax, it's just another day";
    statusText = "LUKEWARM OUT HERE";
    scoreColor = "var(--color-yellow)";
  } else {
    verdict = "Life is good. No SHIT.";
      ...
      <div className="container composite__inner">
        ...
        <div className="composite__gauge-wrap">
          ...
          >
            ...
            {/* Needle */}
            <g
              transform={`rotate(${angle}, 200, 190)`}
