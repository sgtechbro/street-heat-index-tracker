    ...
    <section className="methodology">
      <div className="container">
        ...
        >
          ...
          <ChevronDown
            size={24}
            className={`methodology__chevron${isOpen ? " methodology__chevron--open" : ""}`}
          />
        </button>
        <div className={`methodology__content${isOpen ? " methodology__content--open" : ""}`}>
          <div className="methodology__grid">
            <div className="methodology__text">
              <p>
                Each indicator is scored 0–100 based on verifiable real-world data — sales figures, industry reports, construction activity, media mentions — then weighted by historical signal strength. Higher = more heat.
              </p>
              <p>
            ...
            <div className="formula-box">
              ...
              <ul className="formula-box__items" role="list">
                <li><span className="weight">16%</span><span>R-Word Index</span></li>
                <li><span className="weight">11%</span><span>Stripper Index</span></li>
                <li><span className="weight">11%</span><span>Cardboard Box Index</span></li>
                <li><span className="weight">9%</span><span>Skyscraper Curse</span></li>
                <li><span className="weight">8%</span><span>Champagne Index</span></li>
                <li><span className="weight">8%</span><span>Diaper Rash Index</span></li>
                <li><span className="weight">7%</span><span>Lipstick Index</span></li>
                <li><span className="weight">7%</span><span>Frozen Pizza Index</span></li>
                <li><span className="weight">7%</span><span>Vasectomy Index</span></li>
                <li><span className="weight">6%</span><span>Underwear Index</span></li>
                <li><span className="weight">5%</span><span>Hemline Index</span></li>
                <li><span className="weight">5%</span><span>Hot Waitress Index</span></li>
              </ul>
            </div>
          </div>
        </div>
