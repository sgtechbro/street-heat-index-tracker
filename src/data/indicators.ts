...
export const indicators: Indicator[] = [
  {
    ...
    rationale:
      'Mar 2026: e.l.f. Beauty\'s CFO confirmed the lipstick index is "alive and well". Consumers are trading down from prestige to mass-market brands, a classic recession signal.',
  ...
  },
  {
    ...
    rationale:
      'Mar 2026: RICK revenue fell to $70.3M in Q1 FY2026, down from $76.2M a year ago. Dancers report conditions "worse than 2008." Revenue declined 5.3% YoY.',
  ...
  },
  {
    ...
    rationale:
      "Mar 2026: No strong data either way. Slight softness in apparel broadly, but no dramatic underwear-specific decline reported yet.",
    ...
    sourceUrl:
      "https://finance.yahoo.com/news/mens-underwear-cardboard-boxes-and-giant-skeletons-offbeat-recession-indicators-to-watch-170247772.html",
    cadence: "Quarterly",
    lastUpdated: "Mar 2026",
  },
  {
    ...
    rationale:
      'Mar 2026: Gen Z is leaning into midi skirts, maxi lengths, and "quiet luxury" aesthetics. Low-rise jeans are back. Google Trends for "maxi skirt" up 40% YoY.',
  ...
  },
  {
    ...
    rationale:
      "Mar 2026: The Jeddah Tower (1 km tall) hit 80 floors in Jan 2026 and is accelerating. This is the biggest skyscraper alert since the Burj Khalifa.",
  ...
  },
  {
    ...
    rationale:
      "Mar 2026: FRED PPI for corrugated boxes flat at 391.5 since Oct 2025. US box shipments hit their lowest Q3 since 2015. Production capacity cut ~10% in 2025.",
  ...
  },
  {
    ...
    rationale:
      "Mar 2026: Leisure & hospitality employment at 16.9M per BLS (FRED USLAH), essentially flat. Some softness in hiring, not dramatic enough for full talent reallocation.",
  ...
  },
  {
    ...
    rationale:
      "Mar 2026: Global shipments fell for the 3rd straight year to 266M bottles (lowest since 2005). France domestic market down 4M bottles. No rebound expected.",
    ...
    sourceUrl:
      "https://www.champagne.fr/en/find-out-more/mediaroom/champagne-press/champagne-2025-shipment-review-and-outlook",
    cadence: "Annual",
    lastUpdated: "Jan 2026",
  },
  {
    ...
    desc: "Parents struggling financially start rationing diapers and changing them less frequently. This leads to more diaper rash and higher ointment sales. In 2011, diaper rash ointment sales rose 8% while diaper sales declined.",
    rationale:
      "Mar 2026: No dramatic signals yet. Household budgets are tighter with inflation, but diaper-specific data is quiet. Monitoring consumer sentiment.",
    ...
    sourceUrl:
      "https://www.ksat.com/news/local/2025/02/12/unusual-economic-indicators-lipstick-mens-underwear-champagne-and-work-refrigerators/",
  ...
  },
  {
    ...
    rationale:
      'Mar 2026: "Recession" mentions have been climbing steadily since mid-2025. Tariff fears, geopolitical tensions, and stagnant jobs keeping the R-word in heavy rotation.',
  ...
  },
  {
    ...
    rationale:
      'Mar 2026: US frozen pizza market hit $6.5–7B in 2024, well above pre-pandemic levels. Circana data shows frozen food sales 45% higher than 2019. Conagra\'s 2026 report confirms "takeout-style" frozen foods at $14.3B annually as dining-out costs keep climbing.',
  ...
  },
  {
    ...
    desc: "Urologists report vasectomy consultations spike during recessions. Families literally decide they can't afford more kids. Vasectomies rose one-third from 2006 to 2010 during the Great Recession. A Journal of Urology study found vasectomy rates positively correlate with unemployment (r = 0.556, p < 0.001).",
    rationale:
      "Mar 2026: Vasectomy rates up ~20% nationwide since 2022, with the AUA issuing new 2026 guidelines citing rising annual rates. Economic anxiety compounds the post-Dobbs surge. Younger, childless men are driving the trend at unprecedented rates.",
    ...
    sourceUrl:
      "https://www.npr.org/sections/health-shots/2014/10/21/357786150/when-the-economy-goes-down-vasectomies-go-up",
